...
//   g = gripper      +45 = some open         -45 = closed hard
...
public:
  ...
  // arm pose functions
  double Home (double& b, double& s, double& e, double& w) const;
  ...
  // control functions
  int Ramp (double& b, double& s, double& e, double& w, double& g, double cyc =0.0333);
...
public:
  // control functions
  void linear_ang (double cyc);
  void linear_xyz (double cyc);
