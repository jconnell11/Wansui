...
# =============================================================================
#
# mic_dir.py : direction-of-arrival from ReSpeaker Mic Array V2.0
#
...
class MicDir:
  ...
  def __init__(self):
    ...
    # boost sensitivity 
    mic.set_vad_threshold(15.0)        # default = 15.0

    # main loop runs at 30 Hz
    r = rospy.Rate(30)
    while not rospy.is_shutdown():

      # direction 1-360 deg CCW, 0 if no voice, USB @ -135 deg (225 deg)
      cord = -135
